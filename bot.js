...
if (message.content.startsWith(prefix + 'help')) {
    ...
    ✴ -downloadhelp => Download Movie Help
     ===========================================================
...
var prefix = "-";
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply(' **You Dont Have Perms**');
            ...
            SEND_MESSAGES: false
                  ...
                  message.reply("**:lock: ``Locked Channel``**")
              });
                }
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('**You Dont Have Perms**');
            ...
            SEND_MESSAGES: true
                  ...
                  message.reply("**:white_check_mark: ``Unlocked Channel``**")
              });
    }
...
client.on('message', message => {
   ...
   client.on('message', message => {
     if (message.content === "-download the meg") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" **:movie_camera:  Download The Meg :movie_camera: **" , "  **https://bit.ly/2xJkvMl**")
  .setImage("https://i1.wp.com/thebuzzmag.ca/wp-content/uploads/2018/08/The-Meg-Banner.jpg?ssl=1")
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on('message', message => {
     if (message.content === "-download a quite place") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" **:movie_camera:  Download A Quit Place :movie_camera: **" , "  **https://bit.ly/34Snn5u**")
     	.setImage('https://imagery.zoogletools.com/u/257197/680824855ef09cc1e01a7adad9d1e2ec4a86cfba/original/screen-shot-2018-03-15-at-13-37-02.png')
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on('message', message => {
     if (message.content === "-download The Pursuit of Happyness") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" **:movie_camera:  Download The Pursuit of Happyness :movie_camera: **" , "  **https://bit.ly/2zehfJb**")
     	.setImage('https://youthcharitysociety.files.wordpress.com/2016/03/the-pursuit-of-happyness-banner.jpg?w=619&h=338&crop=1')
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on('message', message => {
     if (message.content === "-download Baywatch") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" **:movie_camera:  Download Baywatch  :movie_camera: **" , "  **https://bit.ly/2XRq2uQ**")
     	.setImage('https://davestrailerpage.co.uk/images/baywatch-800.jpg')
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on('message', message => {
     if (message.content === "-download it") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" **:movie_camera:  Download IT  :movie_camera: **" , "  **https://bit.ly/34TfUmJ**")
     	.setImage('https://www.albawabhnews.com/upload/photo/news/375/9/600x338o/809.jpg?q=1')
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on('message', message => {
     if (message.content === "-download it2") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" **:movie_camera:  Download IT Chapter 2  :movie_camera: **" , "  **https://bit.ly/2RSK3NI**")
     	.setImage('https://nonstopnerd748323109.files.wordpress.com/2019/09/it-pennywise.jpg')
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on('message', message => {
     if (message.content === "-download Bad Boys For Life") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#0000")
  .addField(" **:movie_camera:  Download Bad Boys for Life  :movie_camera: **" , "  **https://bit.ly/3amgj2b**")
     	.setImage('https://lh3.googleusercontent.com/proxy/ScBIOgJBWFey535dojLbS8SXCc7O2JvedzItdRbwQsjqTEnDdPy-DCyRDLykUL_nBBESio8bi1D5r8hCsvh3sNMcz1yYIFgmiEhs8HiQXTP5ndcB_i5yDR3I')
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on('message', message => {
     if (message.content === "-downloadhelp") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
.setColor("#0000")
     .setTitle("Movie Night")
     .setURL("http://moviediscord.cf/")
.addField(" **:movie_camera: Movies Available :movie_camera: **","**Webiste: http://moviediscord.cf/**")
.addField("Baywatch","``-download Baywatch``")
.addField("The Pursuit of Happyness","``-download The Pursuit of Happyness``")
.addField("A Quit Place","``-download a quite place``")
.addField("The Meg","``-download the meg``")
     .addField("IT","``-download it``")
.addField("IT Chapter 2","``-download it2``")
.addField("Bloodshot","``-download Bloodshot``")
.setImage("https://i.ibb.co/stQ2zKZ/Untitled-1.png")
.setThumbnail("https://i.ibb.co/vwhV4yh/movie-logo-design-text-reel-filmstrip-icons-decoration-6829232-removebg-preview.png")
.setFooter("Movie Night")
...
client.login("NzAwNjc1ODAxNDQ3NjYxNjgw.XqBmUg.R8qke_DBgg3g7_nEmw6DdoyzOcM");
